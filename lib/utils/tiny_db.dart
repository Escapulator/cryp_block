...
class TinyDb {
  ...
  //retrieving the bool from shared pref using key
  ...
  //saving list of String to shared preference with respect to its unique key
  static void putListString(String key, List<String> value) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
